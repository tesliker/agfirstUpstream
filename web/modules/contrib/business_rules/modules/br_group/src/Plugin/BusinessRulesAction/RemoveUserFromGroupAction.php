 ...
 *   label = @Translation("Group: Remove user from a group"),
 *   group = @Translation("Group"),
 *   description = @Translation("Remove user from a group on Group module."),
 ...
 * )
 */
class RemoveUserFromGroupAction extends BusinessRulesActionPlugin {
  ...
  public function getSettingsForm(array &$form, FormStateInterface $form_state, ItemInterface $item) {
    ...
    $settings['user_key'] = [
      '#type' => 'radios',
      '#title' => t('Key to remove the user from the group'),
    ...
    $settings['user_name'] = [
      '#type' => 'textfield',
      '#title' => t('User Name'),
      '#description' => t('The user name of the user to be removed from the group. You may use variable or token to fill this information'),
    ...
    $settings['user_id'] = [
      '#type' => 'textfield',
      '#title' => t('User Id'),
      '#description' => t('The user id of the user to be removed from the group. You may use variable or token to fill this information'),
