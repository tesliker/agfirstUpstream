...
class ActionDeleteForm extends EntityConfirmFormBase {
  ...
  public function getQuestion() {
    return $this->t('Are you sure you want to delete %name action? All references to action item will be removed as well.', ['%name' => $this->entity->label()]);
  }
  ...
  public function getCancelUrl() {
    return new Url('entity.business_rules_action.collection');
  }
